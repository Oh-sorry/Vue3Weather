...
export default {
    ...
    created() {
        ...
        const API_KEY = "d9f38c54106acffd2d5f2b64b6df2db5";
        let initialLat = 36.5683;
        let initialLon = 126.9778;

        //get() 메서드를 통해서 우리가 필요로하는 API 데이터 호출
        axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${initialLat}&lon=${initialLon}&appid=${API_KEY}`)
        .then(response => {
